...
def main() -> int:
    ...
    parser.add_argument("--card-embedding-size", type=int, required=True)
    parser.add_argument("--spatial-size", type=int, required=True)
    ...
    model = RecurrentExpertPolicy(config).to(device).eval()
