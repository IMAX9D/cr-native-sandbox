...
IDEMPOTENT_OPS = {
    "ping", "status", "observe", "observe_compact_v1", "probe_grid"
}
...
def build_parser() -> argparse.ArgumentParser:
    ...
    commands.add_parser("observe-compact")
...
def main() -> int:
    ...
    elif arguments.command == "observe-compact":
        payload = {"op": "observe_compact_v1"}
    else:
